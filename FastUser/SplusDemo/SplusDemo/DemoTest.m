...
//    _splusLoginOut = [[UIButton alloc] initWithFrame:CGRectMake(130, 255, 150, 50)];
//    [_splusLoginOut setTitle:@"注销" forState:UIControlStateNormal];
//    [_splusLoginOut setBackgroundColor:[UIColor orangeColor]];
//    [_splusLoginOut setTitleColor:[UIColor blackColor] forState:UIControlStateNormal];
//    [_splusLoginOut addTarget:self action:@selector(splusLoginOutClick:) forControlEvents: UIControlEventTouchUpInside];//处理点击
//    [self.view addSubview:_splusLoginOut];
